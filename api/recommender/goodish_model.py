...
def predicter(game_df):
    ...
    # Add derived feature
    #example_game["meanpointtotal"] = (example_game["avgpointtotal_home"] + example_game["avgpointtotal_away"]) / 2

    # Only keep features used for training
    #example_game = example_game[["avgpointtotal_home", "avgpointtotal_away", "meanpointtotal"]]
